...
import BackgroundBeamsDemo from "../Components/background"; // Make sure path is correct
...
const Hero = () => {
  return (
    <section className="relative text-amber-50 w-full min-h-screen flex items-center justify-center px-8 py-12 rounded-b-[40px] overflow-hidden">
      {/* Background Component as BG */}
